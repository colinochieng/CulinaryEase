document.addEventListener('DOMContentLoaded', function() {
    ...
    imageInput.addEventListener("change", function() {
        ...
        const isValidFile = allowedExtensions.includes(fileName.split('.').slice(-1)[0].toLowerCase())
    ...
    signupForm.addEventListener('submit', function(event) {
        ...
        fetch('http://192.168.0.13:5000/usernames', {
            ...
            body: JSON.stringify({ username: username.value.toLowerCase(), email: email.value.toLowerCase() })
        }
